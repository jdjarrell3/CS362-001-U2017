/** Code taken from:
*	www.sanfoundry.com/java-program-implement-hash-tables/
*  Since I am running low on time due to the unexpected effort
*  required to be able to perform the expected tasks for this
*  course, I have taken the following code so that I can move
*  forward with the first assignment. **/
